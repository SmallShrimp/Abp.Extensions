...
namespace Abp.Extension.Orm.Dapper.Repositories
{
    ...
    public interface IDapperRepository<TEntity, TPrimaryKey> : IDapperUnitOfWork, IRepository where TEntity : class, IEntity<TPrimaryKey>
    {
        /// <summary>
        ...
        //IList<T> Query<T>([NotNull] string sql);
    }
}
