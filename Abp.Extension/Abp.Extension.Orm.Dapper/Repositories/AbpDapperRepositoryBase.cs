...
namespace Abp.Extension.Orm.Dapper.Repositories
{
    ...
    public abstract class AbpDapperRepositoryBase<TEntity, TPrimaryKey> : IDapperRepository<TEntity, TPrimaryKey> where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        //public abstract IDapperDbTransactionHandle Begin(IsolationLevel isolationLevel = IsolationLevel.ReadCommitted);

        public abstract IDapperUnitOfWork Begin(IsolationLevel isolationLevel);
